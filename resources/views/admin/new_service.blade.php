        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4"> Add a New Service</h3>
                    <form method="POST" action="{{url('admin/post_service')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <div class="card mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" id="service" required placeholder="Service Name" name="name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" name="details" required id="details" style="height: 30vh;"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
