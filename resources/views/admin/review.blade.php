        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Review Details</h3>
                    <form method="POST" action="{{url('admin/update_review/'.$review->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <div class="card mb-3">
                                    <div class="card-body text-center shadow">
                                        <img id="img_preview" class="mb-3 mt-4" src="{{asset('Client_pics/'.$review->image)}}" width="160" height="160">
                                        <input style="display:none;" class="my-4" type="file" name="image" id="img_input" accept="image/*" required>
                                        <div class="mb-3">
                                    ...
                                    <div class="col">
                                        <div class="card shadow mb-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    <button class="btn btn-primary btn-sm" onclick="return confirm('Are you sure that you want to update this review?')" type="submit">Update Review details</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
